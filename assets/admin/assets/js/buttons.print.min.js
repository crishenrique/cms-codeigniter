    ...
    "function" == typeof define && define.amd ? define([
        ...
        return b || (b = window),
                c && c.fn.dataTable || (c = require("datatables.net")(b,
                        c).$),
                c.fn.dataTable.Buttons || require("datatables.net-buttons")(b,
                c),
                a(c,
                        b,
                        b.document)
...
//            f.header && (j += "<thead>" + i(h.header,
//                    "th") + "</thead>"),
//                    j += "<tbody>";
//            for (var k = 0,
//                    l = h.body.length; l > k; k++)
//                j += i(h.body[
//                        k
//                ],
//                        "td");
//            j += "</tbody>",
//                    f.footer && (j += "<tfoot>" + i(h.footer,
//                            "th") + "</tfoot>");
//            var m = b.open("",
//                    ""),
//                    n = f.title;
