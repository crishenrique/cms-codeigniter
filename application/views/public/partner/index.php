      ...
      <div class="container">
            ...
            <div class="inner-wrapper-main">
              <div class="col-sm-12">
                <div class="courses course-details">
                  <div class="col-sm-5 course-thumb"> <img src="<?= base_url('assets/uploads/partners/' . $item->image_partner) ?>" alt="Course Image"> </div>
                  <div class="col-sm-7 course-cnt">
                    <h3><?= $item->title_partner ?></h3>
                    <ul class="area-period">
                      <!-- <li>Location <strong>Canada</strong></li> -->
                      <!-- <li>Duration <strong>2 Years</strong></li> -->
                      <!-- <li>Valor do curso <strong>R$ <?= $item->price_partner ?> </strong></li> -->
                      <!-- <li>Total de Vagas <strong>12 Vagas</strong></li> -->
                    </ul>
                    <p><?= $item->text_partner ?></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row offset-top-80">
          ...
          <div class="col-sm-12">
            <div class="row">
              <?php
                if (isset($partnerslim) && !empty($partnerslim)) {
                  foreach ($partnerslim as $key => $item) {
              ?>
                <div class="col-sm-4">
                  <div class="courses">
                    <a href="<?= base_url('parcerias/') . $item->id_partner; ?>">
                      <div class="course-thumb"> 
                        <img src="<?= base_url('assets/uploads/partners/' . $item->image_partner) ?>" alt="Course Image"> 
                      </div>
                      <div class="course-cnt">
                        <div>
                          <h3 style="height:100px; min-height:100px;"><?= mb_substr( $item->title_partner, 0, 50) ?></h3>
                        </div>
                        <!-- <ul class="area-period">
                        ...
                        <div>
                            <h4 style="max-height:100px; min-height:100px;">       
                                <?= mb_substr( $item->text_partner, 0, 100) ?> ...
                            </h4> Ver+
                          </div>
                        <div>
                            <ul class="price-and-seats">
                              <!-- <li><strong>R$ <?= $item->price_partner ?></strong></li> -->
