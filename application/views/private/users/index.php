...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Usuários - loremipsum</title>
        ...
        <script src="<?php echo base_url('assets/private/'); ?>assets/js/ace-extra.min.js"></script>
        <!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->
        <!--[if lte IE 8]>
            <script src="<?php echo base_url('assets/private/'); ?>assets/js/html5shiv.min.js"></script>
            <script src="<?php echo base_url('assets/private/'); ?>assets/js/respond.min.js"></script>
            <![endif]-->
    </head>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <?php include_once VIEWPATH . 'private/users/modal_add.php'; ?>
        ...
        <?php include_once VIEWPATH . 'private/users/functions_js.php'; ?>
