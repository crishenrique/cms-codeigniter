                    ...
                    <div class="panel-body">
                        <form id="myForm" action="" method="POST" enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title_course" type="text" class="form-control" placeholder="Título do curso">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <input name="text_course" type="hidden" class="form-control">
                            </div>
                            <!--EDITOR SUMMERNOTE-->
                            ...
                            <div class="form-group">
                                ...
                                <input name="price_course" type="text" class="form-control" placeholder="Preço do curso">
                            </div>
                            <br style="clear: both" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image_course" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
