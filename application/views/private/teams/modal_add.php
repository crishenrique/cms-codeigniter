                    ...
                    <div class="panel-body">
                        <form  id="myForm" action="" method="POST"  enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name_team" type="text" class="form-control" placeholder="Nome">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <label class="label-control">Cargo</label>
                                <input name="office_team" type="text" class="form-control" placeholder="Cargo">
                            </div>
                            <div class="form-group">
                                <label class="label-control">Rede Social</label>
                                <input name="link_team" type="text" class="form-control" placeholder="Rede social">
                            </div>
                            <br style="clear: both" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image_team" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
