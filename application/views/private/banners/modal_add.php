                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-body">
                        <form id="myForm" action="" method="POST" enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            <input type="hidden" name="id_banner" value="0">
                            <div class="form-group">
                                <label class="label-control">Título</label>
                                <input name="title_banner" type="text" class="form-control" placeholder="Título do banner">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <input name="text_banner" type="hidden" class="form-control">
                            </div>
                            <!--EDITOR SUMMERNOTE-->
                            ...
                            <div class="form-group">
                                ...
                                <input name="link_banner" type="text" class="form-control" placeholder="Link do banner">
                            </div>
                            <br style="clear: both" />
                            ...
                            <br style="clear: both" />
                            <div class="form-group">
                                <label for="id-input-file-2">Imagem do banner</label>
                                <input type="file" name="image_banner" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
