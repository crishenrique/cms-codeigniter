                    ...
                    <div class="panel-body">
                        <form  id="myForm" action="" method="POST"  enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title_service" type="text" class="form-control" placeholder="Título">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <label class="label-control">Texto</label>
                                <input name="text_service" type="text" class="form-control" placeholder="Texto">
                            </div>
                            <br style="clear: both" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image_service" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
