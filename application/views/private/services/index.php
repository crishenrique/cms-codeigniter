...
<html lang="pt-br">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Serviços | loremipsum</title>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <?php include_once VIEWPATH . 'private/services/modal_add.php'; ?>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Lista dos Serviços</h3>
                                <div class="clearfix">
        ...
        <?php include_once VIEWPATH . 'private/services/functions_js.php'; ?>
    </body>
</html>
