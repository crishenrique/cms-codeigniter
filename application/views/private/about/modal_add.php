                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-body">
                        <form  id="myForm" action="" method="POST"  enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            <input type="hidden" name="id_about" value="0">
                            <div class="form-group">
                                <label class="label-control">Título</label>
                                <input name="title_about" type="text" class="form-control" placeholder="Título">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <label class="label-control">Texto</label>
                                <input name="text_about" type="text" class="form-control" placeholder="Texto">
                            </div>
                            <br style="clear: both" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image_about" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
