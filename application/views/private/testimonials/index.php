...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Comentários | loremipsum</title>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <?php include_once VIEWPATH . 'private/testimonials/modal_add.php'; ?>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Lista dos Comentários</h3>
                                <div class="clearfix">
                                        ...
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%" class="hidden-480">Cidade</th>
                                                    <th style="width: 10%">
        ...
        <?php include_once VIEWPATH . 'private/testimonials/functions_js.php'; ?>
    </body>
