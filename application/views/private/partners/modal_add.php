                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-body">
                        <form id="myForm" action="" method="POST" enctype="multipart/form-data" data-parsley-validate class="col-sm-12">
                            <input type="hidden" name="id_partner" value="0">
                            <div class="form-group">
                                <label class="label-control">Título</label>
                                <input name="title_partner" type="text" class="form-control" placeholder="Título do curso">
                            </div>
                            <br style="clear: both" />
                            <div class="form-group">
                                <input name="text_partner" type="hidden" class="form-control">
                            </div>
                            <!--EDITOR SUMMERNOTE-->
                            ...
                            <div class="form-group">
                                ...
                                <input name="price_partner" type="text" class="form-control" placeholder="Preço do curso">
                            </div>
                            <br style="clear: both" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image_partner" id="id-input-file-2" />
                            </div>
                            <br style="clear: both" />
