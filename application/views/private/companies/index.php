    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <?php include_once VIEWPATH . 'private/companies/modal_add.php'; ?>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Empresa</h3>
                                <div class="clearfix">
                                ...
                                <div style="background-color: #0788c0; height:40px"></div>
        ...
        <?php include_once VIEWPATH . 'private/companies/functions_js.php'; ?>
    </body>
